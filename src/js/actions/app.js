import {
  ...
  FILTER_DISCUSSIONS_BY_RELEVANCE, SORT_SURVEY, FETCH_TRANSLATION, PROCESS_DISCUSSION_LIST, PROCESS_UNDISCUSSION_LIST, NAVIGATE_VIEW, LOADING,
...
export function processUnDiscussionList(resp) {
  return {
    type: PROCESS_UNDISCUSSION_LIST,
    resp: resp,
  };
}
